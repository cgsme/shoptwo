...
<body>
	...
	<div class="container">
		<div class="row">
			<div style="margin: 0 auto; margin-top: 10px; width: 950px;">
				...
				<table class="table table-bordered">
					<tbody>
						<tr class="warning">
							<th colspan="5">订单编号:${order.ordertime}</th>
						</tr>
						<tr class="warning">
							<th>图片</th>
							<th>商品</th>
		...
		<div>
			<hr/>
			<form id="orderForm" class="form-horizontal" action="${pageContext.request.contextPath}/PayServlet" style="margin-top: 5px; margin-left: 150px;">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="inputPassword3" value="${user.name}" name="name" placeholder="请输收货人">
					</div>
				</div>
				<div class="form-group">
					<label for="confirmpwd" class="col-sm-1 control-label">电话</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" id="confirmpwd" value="${user.telephone}" name="telephone" placeholder="请输入联系方式">
					</div>
				</div>
				<hr/>
