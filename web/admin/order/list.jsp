	...
	<HEAD>
		...
		<script type="text/javascript">
			...
			function findOrderInfoByOid(oid) {
				...
				// 清楚上次显示的数据
				$("#showDivTab").html("");   // 表格内容
				$("#shodDivOid").html("");  // 订单编号
				// 显示加载提示
				...
				$.post(
						"${pageContext.request.contextPath}/admin/FindOrderInfoByOidServlet",
						{"oid":oid},
						function (data) {
							...
							for (var i=0; i<data.length; i++) {
								content += "<tr style='text-align: center;'>" +
										...
										"</td><td><a target='_blank'>"+ data[i].pname +"</a>"+
										"</td><td>￥"+ data[i].shop_price +"</td>"+
										"<td>"+ data[i].count +"</td>"+
				...
				<TBODY>
					...
					<tr>
						<td class="ta_01" align="center" bgColor="#f5fafe">
							...
							<c:forEach items="${orderList}" var="orders" varStatus="statu">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px">
										<input type="button" value="订单详情" class="clickedElement" onclick="findOrderInfoByOid('${orders.oid}')"/>
									</td>
