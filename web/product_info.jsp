...
<script type="text/javascript">
	...
	function addToCart() {
		...
		location.href="${pageContext.request.contextPath}/CartServlet?pid=${productInfo.pid}&quantity=" + quantity;
	}
	...
	<div class="container">
		<div class="row">
			<div style="border: 1px solid #e4e4e4; width: 930px; margin-bottom: 10px; margin: 0 auto; padding: 10px; margin-bottom: 10px;">
				...
				<a>无公害蔬菜</a>
				<a style="margin-left:650px" href="${pageContext.request.contextPath}/ProductServlet?cid=${cid}&page=${page}">
					返回
				</a>
			</div>
